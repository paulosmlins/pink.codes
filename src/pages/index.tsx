...
const Home = () => {
  ...
  return (
    <div className="container justify-start grow">
          ...
          <div>
            ...
            <AnimateEnter delay={0.8}>
              <div className="pt-4 sm:pt-4">
                <h2 className=" my-2 text-gray-500	  sm:text-start">
                  Muito prazer eu sou o Paulo, faço lives totalmentes
                  aleatorias, sou Desenvolvedor Front-end web e mobile, inimigo
                  número 1 das{" "}
      ...
      <AnimateEnter delay={0.6}>
        <section>
          <h2 className="mb-1 text-lg text-gray-500  sm:text-start">
            Projetos
          </h2>
